...
class CAllcorp3MotorTools
{

	public static function ___1595018847()
	{
		ob_start();
		$arData = $arModuleInfo = array();

		
		if ($moduleID = Solution::moduleID) {
	...
	public static function ___1596018847($data, $signKey = '')
	{
	...
	public static function ___1598018847($hash, $signKey = '')
	{
		$data = false;
	...
	public static function ___1590018847($arData)
	{
		if (is_array($arData)) {
			$arResult = array();
	...
	public static function ___1593018847($arData)
	{
		if (is_array($arData)) {
			$arResult = array();
			foreach ($arData as $key => $value) {
