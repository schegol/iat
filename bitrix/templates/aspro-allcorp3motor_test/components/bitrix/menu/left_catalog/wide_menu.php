                                ...
                                <div class="header-menu-side__wide-submenu-item-inner">
                                    <a class="font_14 dark_link fill-theme-hover" href="<?=$arSubSubItem["LINK"]?>" title="<?=$arSubSubItem["TEXT"]?>">
                                        ...
                                        <?if(
                                            ...
                                            <span class="toggle_block"><?=TSolution::showIconSvg("down header-menu-side__wide-submenu-right-arrow menu-arrow bg-opacity-theme-target fill-theme-target fill-dark-light", SITE_TEMPLATE_PATH.'/images/svg/Triangle_down.svg', '', '', true, false);?></span>
                                        <?endif;?>
                        ...
                        <?if($iCountChilds > $iVisibleItemsMenu && $bWideMenu):?>
                            <li class="header-menu-side__wide-submenu-item--more_items">
                                <span class="dark_link with_dropdown font_11 fill-dark-light-block">
									...
									<?//=TSolution::showIconSvg("", SITE_TEMPLATE_PATH."/images/svg/Arrow_right_small.svg", "", "", false);?>
