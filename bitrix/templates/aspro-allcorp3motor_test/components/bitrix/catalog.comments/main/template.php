...
?><div id="<? echo $templateData['TABS_FRAME_ID']; ?>" class="bx_soc_comments_div bx_important <? echo $templateData['TEMPLATE_CLASS']; ?>"><?
		...
		$activeTabId = "";
		$tabIDList = array();
?><div id="<? echo $templateData['TABS_ID']; ?>" class="bx-catalog-tab-section-container tabs arrow_scroll swipeignore">
	<div class="tabs_wrap">
				...
				if (isset($arTab["NAME"]) && isset($arTab["CONTENT"]))
				{
					...
					switch ($tabId) {
						case "BLOG":
							...
							break;
						case "VK":
							$iconSVG = SITE_TEMPLATE_PATH.'/images/svg/social/VK.svg';
							break;
						case "FB":
							$iconSVG = SITE_TEMPLATE_PATH.'/images/svg/social/FACEBOOK.svg';
							break;
						/*default:
					...
					?>
					<li id="<?=$id?>" class="color_666 bordered rounded-4 font_14 <?=$tabId;?>"><a href="#<?=$id;?>_cont" data-toggle="tab"><?=($iconSVG ? TSolution::showIconSvg(strtolower($tabId), $iconSVG) : '');?><?=$arTab["NAME"]?></a></li>
					<?
