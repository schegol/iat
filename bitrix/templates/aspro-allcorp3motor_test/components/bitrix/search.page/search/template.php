...
<div class="search-page">
	<div class="searchinput">
		...
		<?}?>
			<button class="btn btn-search" type="submit" name="s" value="<?=GetMessage("SEARCH_GO")?>"><?=TSolution::showIconSvg('search', SITE_TEMPLATE_PATH.'/images/svg/Search_black.svg');?></button>
	...
	<?elseif($arResult["ERROR_CODE"]!=0):?>
		...
		<table class="table table-bordered" border="0" cellpadding="5">
			<thead>
				<tr>
					<th align="center" valign="top"><?=GetMessage("SEARCH_OPERATOR")?></th><th valign="top"><?=GetMessage("SEARCH_SYNONIM")?></th>
	...
	<?elseif(count($arResult["SEARCH"])>0):?>
		...
		<?if($arParams["DISPLAY_BOTTOM_PAGER"] != "N") {?>
			<div class="bottom_nav"><?echo $arResult["NAV_STRING"];?></div>
		<?}?>
		<br />
		<p>
