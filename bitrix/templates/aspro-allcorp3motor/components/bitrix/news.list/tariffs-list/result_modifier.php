	...
	if($arAllItems){
		foreach($arAllItems as $arItemPrices){
			if ($arItemPrices['TARIF_ITEM']) {
				$arItemPrices['TARIF_ITEM']['VALUE'] = TSolution\TariffItem::decodePropertyValue($arItemPrices['TARIF_ITEM']['VALUE']);
			}
...
foreach($arResult['ITEMS'] as $key => &$arItem){
	...
	if($arItem['DISPLAY_PROPERTIES']){
		...
		if ($arItem['DISPLAY_PROPERTIES']['TARIF_ITEM']) {
			$arItem['DISPLAY_PROPERTIES']['TARIF_ITEM']['VALUE'] = TSolution\TariffItem::decodePropertyValue($arItem['DISPLAY_PROPERTIES']['TARIF_ITEM']['VALUE']);
