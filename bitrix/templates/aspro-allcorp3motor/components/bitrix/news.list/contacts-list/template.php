											...
											<?if($arItem['MIDDLE_PROPS']['METRO']['VALUE']):?>
												<div class="contacts-list__item-metro">
													<?foreach((array)$arItem['MIDDLE_PROPS']['METRO']['VALUE'] as $metro):?>
														<div class="contacts-list__item-metro__value"><?=TSolution::showIconSvg('metro', SITE_TEMPLATE_PATH.'/images/svg/Metro.svg');?><span class="font_14 color_666"><?=$metro?></span></div>
													<?endforeach;?>
												</div>
											<?endif;?>

											<?if($arItem['MIDDLE_PROPS']['SCHEDULE']['VALUE']):?>
												<div class="contacts-list__item-schedule"><?=TSolution::showIconSvg('schedule', SITE_TEMPLATE_PATH.'/images/svg/Schedule.svg');?><span class="font_14 color_666"><?=$arItem['MIDDLE_PROPS']['SCHEDULE']['~VALUE']['TEXT']?></span></div>
											<?endif;?>
