...
$arResult['GALLERY'] = TSolution\Functions::resizeImages($arResult['GALLERY']);
	...
	<div class="catalog-detail__top-info flexbox flexbox--direction-row flexbox--wrap-nowrap">
		...
		<div class="catalog-detail__main scrollbar">
			<div class="catalog-detail__main-wrapper">
				...
				<?if($arResult['CHARACTERISTICS']):?>
					<div class="char-side">
<!--						<div class="char-side__title font_15 color_333 font-bold">--><?php //=($arParams["T_CHARACTERISTICS"] ? $arParams["T_CHARACTERISTICS"] : Loc::getMessage("T_CHARACTERISTICS"));?><!--</div>-->
