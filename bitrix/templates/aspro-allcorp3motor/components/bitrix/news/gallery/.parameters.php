...
if(\Bitrix\Main\Loader::includeModule(VENDOR_MODULE_ID)){
	...
	TSolution::AddComponentTemplateModulePageBlocksParams(__DIR__, $arPageBlocksParams, array('SECTION' => 'GALLERY_PAGE', 'OPTION' => 'GALLERY_LIST_PAGE'), 'SECTION_ELEMENTS_TYPE_VIEW'); // add option value FROM_MODULE
	TSolution::AddComponentTemplateModulePageBlocksParams(__DIR__, $arPageBlocksParams, array('SECTION' => 'GALLERY_PAGE', 'OPTION' => 'GALLERY_DETAIL_PAGE'), 'ELEMENT_TYPE_VIEW'); // add option value FROM_MODULE
}
