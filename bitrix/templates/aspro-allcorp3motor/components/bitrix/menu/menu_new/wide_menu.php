...
<li class="header-menu__dropdown-item <?=$liClass?>">
    ...
    <div class="header-menu__wide-item-wrapper">
        <a class="<?=$contentType == 'NO_CONTENT' ? 'font_14' : 'font_15'?> dark_link switcher-title" href="<?=$arSubItem["LINK"]?>">
            ...
            <?if($bShowChilds):?>
                <?=TSolution::showIconSvg(' header-menu__wide-submenu-right-arrow only_more_items fill-dark-light-block', SITE_TEMPLATE_PATH.'/images/svg/Arrow_right_small.svg');?>
            <?endif;?>
        </a>
        <?if($bShowChilds):?>
                        ...
                        <span class="header-menu__wide-submenu-item-inner">
                            <a class="font_14 dark_link color_666 fill-theme-hover fill-dark-light-block" href="<?=$arSubSubItem["LINK"]?>">
                                ...
                                ?><?if(
                                    ...
                                    ?><span class="toggle_block"><?=TSolution::showIconSvg("down header-menu__wide-submenu-right-arrow menu-arrow bg-opacity-theme-target fill-theme-target", SITE_TEMPLATE_PATH.'/images/svg/Triangle_down.svg', '', '', true, false);?></span>
                                <?endif;?>
                                <?if($bShowChilds):?>
                                    <?=TSolution::showIconSvg(' header-menu__wide-submenu-right-arrow only_more_items fill-dark-light-block', SITE_TEMPLATE_PATH.'/images/svg/Arrow_right_small.svg');?>
                                <?endif;?>
                ...
                <?if($iCountChilds > $iVisibleItemsMenu && $bWideMenu):?>
                    <li class="header-menu__wide-submenu-item--more_items">
                        <span class="dark_link fill-theme-hover1 with_dropdown font_13 fill-dark-light-block svg">
                            ...
                            <?=TSolution::showIconSvg(" menu-arrow", SITE_TEMPLATE_PATH."/images/svg/Arrow_right_small.svg", "", "", true, false);?>
                        </span>
