...
<?elseif($id):?>
	<?$template = 'popup';
	foreach(GetModuleEvents(VENDOR_MODULE_ID, 'OnAsproTemplateForm', true) as $arEvent) // event for manipulation widget
		ExecuteModuleEventEx($arEvent, array(&$template, $id));?>
	<?$APPLICATION->IncludeComponent(
		"aspro:form.".VENDOR_SOLUTION_NAME, $template,
		Array(
