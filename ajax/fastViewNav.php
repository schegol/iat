...
<?if(
	...
	$arOrder['CACHE'] = array('TAG' => TSolution\Cache::GetIBlockCacheTag($iblockId));

	$arNewItem = array();
	$arItems = TSolution\Cache::CIBlockElement_GetList($arOrder, $arFilter, false, false, array('DETAIL_PAGE_URL'));
