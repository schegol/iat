...
if($iblock_id){
	if(
		$arMainGallery = TSolution\Cache::CIBlockElement_GetList(
			array(
				'SORT' => 'ASC',
				'ID' => 'DESC',
				'CACHE' => array(
					'TAG' => TSolution\Cache::GetIBlockCacheTag($iblock_id),
					'MULTI' => 'N'
				)
			),
			array(
...
<?if($galleryId):?>
	<?$APPLICATION->IncludeComponent(
		...
		array(
			...
			"RIGHT_LINK" => "gallery/",
			"CHECK_REQUEST_BLOCK" => TSolution::checkRequestBlock("gallery"),
