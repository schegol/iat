...
$MESS['TITLE_DEFAULT'] = 'Наши продукты';
$MESS['HIT_PROP'] = 'Свойство с хитами';
$MESS['S_ORDER_PRODUCT'] = 'Текст кнопки "Заказать"';
$MESS['S_ORDER_PRODUCT_TEXT'] = 'Заказать';
$MESS['S_MORE_PRODUCT'] = 'Текст кнопки "Подробнее"';
$MESS['S_MORE_PRODUCT_TEXT'] = 'Подробнее';
$MESS['S_SHOW_SECTION'] = 'Показывать раздел';
$MESS['S_COUNT_IN_LINE'] = 'Количество элементов в строке';
$MESS["SHOW_OLD_PRICE_NAME"] = "Отображать старую цену";
$MESS["T_SHOW_DISCOUNT_PRICE"] = "Отображать экономию";
...
$MESS ['FROM_THEME'] = "Из настроек решения";
?>